...
def insertNanotekDetails(page_html):
    ...
    ################### Motherboard ########################
    # containers = content.findAll("div", {"id", "2099928543"})
    ...
    ################### RAM ########################
    # containers = content.findAll("div", {"id", "1599562875"})


    ################### VGA ########################
    # containers = content.findAll("div", {"id", "274725464"})


    ################### Hard_Disk ########################
    # containers = content.findAll("div", {"id", "1754104783"})


# url = 'https://docs.google.com/spreadsheets/d/1ZMGJc69uk2fVEFPKNu1UboxE3Wh5ftI9yUJuIbQzZi4/pubhtml#'
# uClient = uReq(url)
# page_html = uClient.read()
# uClient.close()
# insertNanotekDetails(page_html)
insertNanotekDetails('abc')
